 ...
 */
export function formatRequestMetadata(request: Request): string[] {
  return [
    `╔══════════════════════════════════════════════════════════════╗`,
    `║                      REQUEST DETAILS                         ║`,
    `╠══════════════════════════════════════════════════════════════╣`,
 ...
 */
export function formatSkillsSection(request: Request): string[] {
 ...
 */
export function formatContentSection(content: string): string[] {
  const lines: string[] = [
    `╠══════════════════════════════════════════════════════════════╣`,
    `║ Content:                                                     ║`,
    `╠══════════════════════════════════════════════════════════════╣`,
 ...
 */
export function formatDetailContent(request: Request | undefined, content: string): string {
  if (!request) return content;

  const lines: string[] = [
    ...formatRequestMetadata(request),
    ...formatSkillsSection(request),
